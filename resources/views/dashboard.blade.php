        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <a href="{{ route('manifest.index') }}" class="group bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 hover:shadow-md transition flex items-start gap-4">
                    <div class="shrink-0 flex items-center justify-center w-12 h-12 rounded-lg bg-blue-50 text-blue-800 group-hover:bg-blue-800 group-hover:text-white transition">
                    ...
                    <div>
                        <h4 class="font-semibold text-gray-800 group-hover:text-blue-800 transition">
